...
path_directory = '/home/SharedData/lakshya/ablation/test' # base working directory
...
test_folder=os.listdir(path_directory+ test_data +'/')

list_test=[]
for video_no in test_folder:
	track_path = path_directory+test_data +'/'+video_no+'/'
...
load_path = path_directory+'/checkpoint/bcetrain_' + epoch_number_input + '.pth'
	...
	with torch.no_grad():
		for i,data in enumerate(testloader):
			...
			for i in range(0,x.shape[0]):
		                ...
		                pth = path_directory + test_data + '/'+track_path[i]+'/result/'+name[i]
