...
path = '/home/SharedData/lakshya/AlphaPose/sliding_window_output/02/'
...
for file_org in files_path:
	...
	for data_org in datas_org:
		count = len(str(len(os.listdir('/home/SharedData/lakshya/frames/train/'+video_name))))
		frame = str(int(data_org[2])).zfill(count)
		image = cv2.imread('/home/SharedData/lakshya/frames/train/'+video_name+'/'+frame+'.jpg')
		x_org = data_org[3:20]
		...
		cv2.imwrite('/home/SharedData/lakshya/AlphaPose/visualize_output_sliding_window/'+video_name+'/'+frame+'.jpg',image)
		print('/home/SharedData/lakshya/AlphaPose/visualize_output_sliding_window/'+video_name+'/'+frame+'.jpg')
