...
1) Create two seperate anaconda environments for AlphaPose and simple-HRNet to avoid any possible conflicts as they both have common dependencies. Run [pip install -r requirements.txt] present in the folders of each in your respective environments.
